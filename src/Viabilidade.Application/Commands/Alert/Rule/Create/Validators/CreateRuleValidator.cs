...
namespace Viabilidade.Application.Commands.Alert.Rule.Create.Validators
{
    public class CreateRuleValidator : AbstractValidator<CreateRuleRequest>
    {
        ...
        public CreateRuleValidator(IIndicatorRepository indicadorRepository, IOperatorRepository operadorRepository, IAlgorithmRepository algoritmoTipoRepository, IEntityRepository entidadeRepository, ITagRepository tagRepository, IRSegmentEntityRepository rSegmentEntityRepository)
        {
